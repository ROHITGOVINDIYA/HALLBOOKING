        ...
        <form method="POST">
            ...
            <div class="p-4">
                ...
                <div class="mb-4">
                    ...
                    <input name="admin_pass" type="password"  required class="form-control shadow-none text-center"
                        placeholder="Password">
                </div>
                <button name="login" type="submit" class=" btn text-dark fw-bold custom-bg shadow-none">LOGIN</button>
            </div>
        </form>
    </div>
